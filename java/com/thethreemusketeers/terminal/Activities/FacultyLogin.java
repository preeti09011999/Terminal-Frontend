...
public class FacultyLogin extends AppCompatActivity {
    ...
    TextView forgotPasswordLink , signUpLink,attentionRequiredTowardsFacultyId , attentionRequiredTowardsFacultyPassword, attentionRequiredTowardsInvalid;
    EditText facultyId , facultyPassword;
    Button loginBtn;
    Boolean proceedingNextFlagId = true, proceedingNextFlagPassword = true, facEyeTogglerFlag = true;
    ImageView facPasswordEye;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facPasswordEye = findViewById(R.id.fac_password_eye);
        ...
        facPasswordEye.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(facEyeTogglerFlag){
                    facultyPassword.setTransformationMethod(null);
                    facEyeTogglerFlag = false;
                    facPasswordEye.setImageResource(R.drawable.password_eye_crossed);
                } else{
                    facultyPassword.setTransformationMethod(new PasswordTransformationMethod());
                    facEyeTogglerFlag = true;
                    facPasswordEye.setImageResource(R.drawable.password_eye);
                }
            }
        }));
